...
from duckdb.functional import FunctionNullHandling, PythonUDFType, PythonUDFKind
...
class DuckDBPyConnection:
    ...
    def create_function(self, name: str, function: function, parameters: Optional[List[DuckDBPyType]] = None, return_type: Optional[DuckDBPyType] = None, *, type: Optional[PythonUDFType] = PythonUDFType.NATIVE, kind: Optional[PythonUDFKind] = PythonUDFKind.COMMON, batch_size: int = 2048, null_handling: Optional[FunctionNullHandling] = FunctionNullHandling.DEFAULT, exception_handling: Optional[PythonExceptionHandling] = PythonExceptionHandling.DEFAULT, side_effects: bool = False) -> DuckDBPyConnection: ...
